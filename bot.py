...
class CardChecker:
    ...
    def check(self, card_line):
        ...
        try:
            ...
            'NEWSYSTEM': '1',
            'RETURN_TSS': '1',
            'WEB_ORDER_ID': '23617074',
            'SITE': 'DESKTOP',
            'AGENT': 'Mozilla%2F5%2E0%20%28Windows%20NT%2010%2E0%3B%20Win64%3B%20x64%29%20AppleWebKit%2F537%2E36%20%28like%20Gecko%29%20Chrome%2F142%2E0%2E0%2E0%20Safari%2F537%2E36',
            'MERCHANT_ID': 'bvgairflo',
            'ORDER_ID': '63561CC4-9293-30B2-22B94B9D65F21FE6',
            'USER_ID': '5187954',
            'ACCOUNT': 'suttonsdobiesecomm',
            'AMOUNT': '2697',
            'DISCOUNT': '0',
            'CURRENCY': 'GBP',
            'TIMESTAMP': '20251115231115',
            'SHA1HASH': 'be9ea9b52b22ec05db51384512f0d67d0b46f563',
            'AUTO_SETTLE_FLAG': '1',
